...
class AppVisitScreen extends StatefulWidget {
  const AppVisitScreen({Key? key}) : super(key: key);

  @override
  State<AppVisitScreen> createState() => _AppVisitScreenState();
}

class _AppVisitScreenState extends State<AppVisitScreen> {
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "${providerF!.appinfo[index].download}",
                            style: TextStyle(
                                fontFamily: 'Lily',
                                fontSize: 15,
                                color: Colors.black,
                    ...
                    itemBuilder: (context, i) {
                      return Container(
                        ...
                        child: ClipRRect(
                            ...
                            child: Image.asset(
                              "${providerF!.appinfo[index].photo![i]}",
                            )),
                      );
                    },
                    scrollDirection: Axis.horizontal,
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      width: 300,
                      child: Text(
                        "${providerF!.appinfo[index].abgame}",
                        style: TextStyle(
                            fontFamily: 'Lily',
                            fontSize: 15,
                            color: Colors.black54,
